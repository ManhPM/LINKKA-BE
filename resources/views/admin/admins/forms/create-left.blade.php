<div class="col-12 col-md-9">
    <div class="card">
        ...
        <div class="row card-body">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="mb-3">
                    <x-label for="password" text="{{ __('Mật khẩu') }}" icon="ti ti-square-key" required="true" />
            ...
            <div class="col-md-6 col-sm-12">
                <div class="mb-3">
                    <x-label for="branch_name" text="{{ __('Tên chi nhánh') }}" icon="ti ti-building-store"
                        required="true" />
                    <x-input name="branch_name" :value="old('branch_name')" :required="true"
            ...
            <div class="col-md-6 col-sm-12">
                <div class="mb-3">
                    <x-label for="branch_phone" text="{{ __('Số điện thoại chi nhánh') }}" icon="ti ti-phone"
                        required="true" />
                    <x-input-phone name="branch_phone" :value="old('branch_phone')" :required="true" />
                </div>
            </div>
            <div class="col-12">
                <div class="mb-3">
                    <x-label for="branch_address" text="{{ __('Địa chỉ chi nhánh') }}" icon="ti ti-map-pin"
                        required="true" />
                    <x-input name="branch_address" :value="old('branch_address')" :required="true"
        ...
        <script>
            (function() {
                ...
                // Initialize on load in case of old() values
